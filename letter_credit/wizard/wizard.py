...
class ExtendAmountWizard(models.TransientModel):
    ...
    letter_credit = fields.Many2one('letter.credit')
...
class AccountPaymentRegisterInherit(models.TransientModel):
    ...
    # == Business fields ==
    letter_credit = fields.Many2one("letter.credit", string="LC")
    ...
    line_ids = fields.Many2many('account.move.line', 'account_payment_register_move_line_rel_lc', 'wizard_id_lc',
                                'line_id_lc',
